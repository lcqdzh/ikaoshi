          ...
          <p class="pull-right visible-xs">
            ...
            <div class="row clearfix">
                    ...
                    <div class="col-md-6 column">
                        <form action="admin_update_password_page" method = "post" role="form">
                        	<div class="form-group">
                                 <label for="exampleInputEmail1">请输入原密码:</label><input class="form-control"   id="exampleInputzhuanye1" type = "password" name = "old_password" />
                            </div>                                                     
                            <div class="form-group">

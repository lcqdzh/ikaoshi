        ...
        <div class="col-xs-12 col-sm-9">
          ...
          <div class="row">
            ...
            <div class="panel panel-default">
					  ...
					  <div class="panel-heading">已批改试卷列表</div>
					  <!-- Table -->
					  <table class="table">
					   <thead>
					      <tr>
							 ...
							 <th style="text-align:center">查看试卷</th>				         				        
					      </tr>
					   </thead>
					   <tbody>
					   <c:if test="${!empty stu_score_done_list}"> 
		               		<c:forEach items="${stu_score_done_list}" var="test">
					      		<tr>
					         		...
					         		<td style="text-align:center">${test.test_score }</td>
					         		<td style="text-align:center"><a class=" btn btn-primary" href="show_test_detail?test_Id=${test.test_Id }" role="button">查看详情</a></td>                                    
          ...
          <div class="panel panel-default">
					  <!-- Default panel contents -->
					  <div class="panel-heading">未批改试卷列表</div>
					  <!-- Table -->
					  <table class="table">
					   <thead>
					      <tr>
					   ...
					   <tbody>
					   <c:if test="${!empty stu_testd_list}"> 
		               		<c:forEach items="${stu_testd_list}" var="test">
					      		<tr>
					         		<td style="text-align:center">${test.test_Id}</td>
					         		<td style="text-align:center">${test.test_name }</td>
					         		<td style="text-align:center">${test.tea_name}</td>

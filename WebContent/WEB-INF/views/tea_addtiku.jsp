      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-12 col-sm-9">
          ...
          <div class="jumbotron">
			...
			<form class="form-signin" action="tea_addtiku_f">
        	<h2 class="form-signin-heading"  >题库名称</h2>
          	<input type="text" id="inputEmail" name="tiku_name" class="form-control" placeholder="" required autofocus>
